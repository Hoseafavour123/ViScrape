...
import { CreateWorkflowSchemaType } from '@/shema/workflow'
import { Input } from '@/components/ui/input'
import { Textarea } from '@/components/ui/textarea'
import { useMutation } from '@tanstack/react-query'
import { createWorkflow } from '@/actions/workflows/createWorkflow'
import { toast } from 'sonner'
import { createCredentialSchema, CreateCredentialSchemaType } from '@/shema/credential'
...
const CreateCredentialDialog = ({triggerText}:{triggerText?: string}) => {
    ...
    const { mutate, isPending} = useMutation({
        ...
        onError: (error) => {
            toast.error(`Error creating credential: ${error.message}`, {id:'create-credential'})
        }
    })

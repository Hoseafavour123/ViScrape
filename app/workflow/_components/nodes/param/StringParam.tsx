...
const StringParam = ({ param, value, updateNodeParamValue}: ParamProps) => {
  ...
  return (
    <div className='space-y-1 p-1 w-full'>
        ...
        <Input id={id} value={internalValue}
         placeholder='Enter value here' onChange={e => setInternalValue(e.target.value)} onBlur={(e => updateNodeParamValue(e.target.value))} className='text-xs' />
        {param.helperText && (
